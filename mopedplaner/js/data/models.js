...
export const MODELS = [
  // ── Klassiker ────────────────────────────────────────────────
  {
    ...
    years: '1955–1957', engine: 'Rh 50', ccm: 47.6, ps: 1.5, vmax: 40,
  ...
  },
  {
    ...
    years: '1957–1959', engine: 'Rh 50', ccm: 47.6, ps: 1.5, vmax: 40,
  ...
  },
  {
    ...
    years: '1959–1963', engine: 'Rh 50 E', ccm: 47.6, ps: 1.6, vmax: 40,
  ...
  },
  {
    ...
    years: '1958–1964', engine: 'KR-Motor (2-Gang)', ccm: 47.6, ps: 2.1, vmax: 50,
  ...
  // ── Vogelserie ───────────────────────────────────────────────
  {
    ...
    years: '1964–1970', engine: 'M53 (2-/3-Gang)', ccm: 47.6, ps: 2.0, vmax: 40,
  ...
  },
  {
    ...
    years: '1964–1975', engine: 'M53/M54 (3-Gang)', ccm: 49.8, ps: 3.4, vmax: 60,
  ...
  },
  {
    ...
    years: '1966–1972', engine: 'M54 (4-Gang)', ccm: 49.8, ps: 4.6, vmax: 75,
  ...
  },
  {
    ...
    years: '1972–1975', engine: 'M54 (4-Gang)', ccm: 49.8, ps: 3.4, vmax: 60,
  ...
  // ── Schwalbe ─────────────────────────────────────────────────
  {
    ...
    years: '1964–1968', engine: 'M53 KF (3-Gang)', ccm: 49.8, ps: 3.4, vmax: 60,
  ...
  },
  {
    ...
    years: '1968–1980', engine: 'M53/1 KF (3-/4-Gang)', ccm: 49.8, ps: 3.4, vmax: 60,
  ...
  },
  {
    ...
    years: '1980–1986', engine: 'M531/M541 KF (3-/4-Gang)', ccm: 49.8, ps: 3.4, vmax: 60,
  ...
  // ── Mopeds & Mokicks (S-Reihe) ───────────────────────────────
  {
    ...
    years: '1975–1980', engine: 'M53/2 (3-Gang)', ccm: 49.8, ps: 3.6, vmax: 60,
  ...
  },
  {
    ...
    years: '1980–1990', engine: 'M531/M541 (3-/4-Gang)', ccm: 49.8, ps: 3.7, vmax: 60,
  ...
  },
  {
    ...
    years: '1983–1990', engine: 'M741 (4-Gang)', ccm: 69.9, ps: 5.6, vmax: 75,
  ...
  },
  {
    ...
    years: '1990–2002', engine: 'M531/M541', ccm: 49.8, ps: 3.7, vmax: 60,
  ...
  },
  {
    ...
    years: '1990–2002', engine: 'M743', ccm: 69.9, ps: 5.6, vmax: 75,
    mix: '1:50', tank: 8.7, weight: 82, voltage: '12 V',
  ...
  // ── Roller ───────────────────────────────────────────────────
  {
    ...
    years: '1986–2002', engine: 'M541/M542 (4-Gang)', ccm: 49.8, ps: 3.7, vmax: 60,
  ...
  },
  {
    ...
    years: '1986–1990', engine: 'M741/M742 (4-Gang)', ccm: 69.9, ps: 5.6, vmax: 75,
  ...
  // ── Duo & Sonderfahrzeuge ────────────────────────────────────
  {
    ...
    years: '1972–1980', engine: 'M53 (angepasst, Rückwärtsgang-Getriebe)', ccm: 49.8, ps: 3.4, vmax: 50,
  ...
  },
  {
    ...
    years: '1980–1989', engine: 'M541 (angepasst)', ccm: 49.8, ps: 3.4, vmax: 50,
  ...
  },
  {
    ...
    years: '1988–1990', engine: 'M541 (angepasst)', ccm: 49.8, ps: 3.7, vmax: 50,
  ...
  // ── Export- & Sondermodelle ──────────────────────────────────
  {
    ...
    years: '1970er', engine: 'M54 (4-Gang)', ccm: 49.8, ps: 4.6, vmax: 75,
    mix: '1:33', tank: 8.5, weight: 79, voltage: '6 V',
    tags: ['Export', 'Selten'],
  ...
  },
  {
    ...
    years: 'Prototyp/Kleinserie', engine: 'variiert', ccm: 49.8, ps: null, vmax: null,
  ...
  },
  {
    ...
    years: '—', engine: 'variiert', ccm: null, ps: null, vmax: null,
